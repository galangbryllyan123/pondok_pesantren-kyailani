    ...
    <div class="container">
        <div class="row">
			...
			<div class="col-md-4">
                ...
                <div class="fb-page" data-href="https://www.facebook.com/galang/" data-tabs="timeline" data-width="300" data-height="300" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/galang/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/galang/">PONDOK PESANTREN
DARUL KAILANI PURWODADI</a></blockquote></div>
    ...
    <div class="footer-copyright">
        <div class="container">
            <div class="row">
                <div class="col-md-11">
                    <p>© <?php echo Date('Y'); ?> Powered by pondok</p>
                </div>
            </div>
        </div>
    </div>
